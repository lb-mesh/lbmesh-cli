...
MongoClient.connect(url, {"useNewUrlParser": true}, function(err, db) {
    ...
    if( err ){
        ...
        async.parallel([
            ...
            function(callback){
                dbase.collection("administrator").insertOne({"fullname":"Demo User","username":"demo@demo.com","email":"demo@demo.com","password":hashPassword('demo123'),"permissions":"member,data,billing,import,reports"})
            },
            function(callback){
